...
- **John Ousterhout, _A Philosophy of Software Design_** — 2nd ed., **2021**, ISBN 173210221X — Ch. 4, "Modules Should Be Deep"
  Deep vs shallow modules. Read it knowing the skills repo **rejects** what it calls his depth-as-line-ratio metric ("rewards padding the implementation") while quoting his thesis approvingly.
  **Open question, unresolved:** it could not be confirmed that Ousterhout actually defines depth as a *ratio*. Secondary summaries consistently show a qualitative cost/benefit treatment plus a rectangle diagram — **no formula**. Settling this needs the book text. Don't retell the disagreement as "Ousterhout is wrong and the repo corrects him" until it is settled.
...
- **Does Ousterhout actually define depth as a ratio?** Unresolved — see his entry above. Affects how lesson 0002 tells the story.
- **Cockburn's walking skeleton.** Origin unresolved; both known URLs return **404**. Affects lesson 0006, where the three ideas must be separated precisely.
- **Deliberately omitted rather than guessed:** Bloch's *Effective Java* item numbers, Evans' chapter numbers, Beck's ISBN, Agans' full list of 9 rules, Stevens/Myers/Constantine 1974 details. Per the no-guessed-locators rule.
- **OpenAI's "Harness engineering" post** returned HTTP 403 to automated fetch. Widely-repeated figures from it (three-person team, five months, ~1M lines, ~1,500 merged PRs) are **unverified** and must not be cited until fetched manually.
